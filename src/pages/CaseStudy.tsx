...
export default function CaseStudy() {
  ...
  const projectsData: Record<string, any> = {
    ...
    '4': {
      ...
      role: 'Lead Designer & Developer',
      duration: '2 Weeks',
      image: 'https://images.unsplash.com/photo-1508344928928-7165b67de128?auto=format&fit=crop&q=80&w=2000',
  ...
  const caseStudy = id && projectsData[id] ? projectsData[id] : {
    ...
    role: '-',
    duration: '-',
    image: 'https://images.unsplash.com/photo-1540932239986-30128078f3c5?auto=format&fit=crop&q=80&w=2000',
